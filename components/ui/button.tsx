...
const buttonVariants = cva(
  'flex items-center justify-center rounded-md font-medium transition hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue5 ',
  {
    variants: {
      variant: {
