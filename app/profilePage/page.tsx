...
import ProfilePageFilter from '@/components/filter/profile'
// import getMatch from '@/actions/getMatch'

const page = async () => /* const matchs = await getMatch()*/ /* eslint-disable-next-line no-console*/ /* console.log( matchs )*/ (
  <div className="flex flex-col h-screen">
    ...
    <div className="grid grid-cols-3 h-[calc(100%-101px)]">
      ...
      <div className="w-full h-full col-span-1">
        < ProfilePageFilter height={0} width={0}/>
      </div>
    </div>
  </div>
)
