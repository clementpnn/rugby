      ...
      <div className='w-full bg-neutral1 p-6 flex flex-col items-start gap-y-3'>
        <div className='flex flex-col items-start gap-y-6 bg-neutral1 w-full h-full rounded-md'>
          ...
          <div className='bg-neutral0 w-full h-full rounded-md p-10 flex flex-row gap-x-10'>
            <Link href='./listing' className='w-full h-full rounded-md border-[1px] border-neutral3 flex flex-col gap-y-[52px] items-center justify-center hover:bg-neutral1'>
              <PiListMagnifyingGlass className='w-20 h-20 text-neutral3'/>
              <p className='h3-barlow-d text-blue6'>LISTING</p>
            </Link>
            <Link href='./place' className='w-full h-full rounded-md border-[1px] border-neutral3 flex flex-col gap-y-[52px] items-center justify-center hover:bg-neutral1'>
              <PiListMagnifyingGlass className='w-20 h-20 text-neutral3'/>
              <p className='h3-barlow-d text-blue6'>PLACE</p>
            </Link>
            <Link href='./sad' className='w-full h-full rounded-md border-[1px] border-neutral3 flex flex-col gap-y-[52px] items-center justify-center hover:bg-neutral1'>
